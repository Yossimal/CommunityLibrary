...
<asp:Content ContentPlaceHolderID="Body" runat="server">
    <form id="form1" runat="server">
        <div>
            <input type="text" placeholder="Enter The Book Name" runat="server" class="form-control" ID="bookName"/>
            <input type="text" placeholder="Enter the book code" runat="server" ID="bookCode" class="form-control"/>
            <input type="text" placeholder="Enter the book Author" runat="server" ID="bookAuthor" class="form-control"/>
